			...
			<div id="content">
				...
				<div class="container-fluid">
					<div class="container">
						...
						<form action="<c:url value='/quan-tri/sua-binh-luan/${comment.id }'/>" method="post"
							style="width: 100%; margin-left: auto; margin-right: auto;">
							<div style="padding: 20px;">
							<div class="mb-3">
									<label for="postId" class="form-label">Mã Bài Viết</label> <input
										type="text" class="form-control" id="postId" name="postId" value="${comment.postId.id }">
								</div>
								<div class="mb-3">
									<label for="userId" class="form-label">Mã Người Dùng</label> <input
										type="text" class="form-control" id="userId" name="userId" value="${comment.userId.id }">
								</div>
								<div class="mb-3">
									<label for="childOfCommentId" class="form-label">Mã Bình Luận Cha</label> <input
										type="text" class="form-control" id="childOfCommentId" name="childOfCommentId" value="${comment.childOfCommentId.id }">
								</div>
								<div class="mb-3">
									<label for="content" class="form-label">Nội Dung</label> <input
										type="text" class="form-control" id="content" name="content" value="${comment.content}">
								</div>														
								<div>
									<button class="btn btn-primary" style="width: 100%;"
										type="submit" id="btnAddComment">Sửa
										Bài Viết</button>
								</div>
							</div>
						</form>
